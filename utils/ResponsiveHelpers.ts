...
import { DIMENSION_MODES, SMALL_SCREEN_WIDTH, TABLET_SCREEN_WIDTH } from "@/constants/ResponsiveConstants";
...
export const getDimensionModeOfScreen = (window: any) => {
...
export const isLandscapeMode = (currentViewMode: string) => {
  if (!isWeb) {
