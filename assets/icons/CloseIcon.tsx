...
import { mainTextColor } from '@/styles';
import { IconProps } from './types';

export const CloseIcon: React.FC<IconProps> = ({ width = 24, height = 24, fill = mainTextColor, stroke = "#000", strokeWidth = 2, testID }) => (
    <Svg   width={width} height={height} viewBox={`0 0 ${width} ${height}`} fill={fill} testID={testID}>
        <Path
